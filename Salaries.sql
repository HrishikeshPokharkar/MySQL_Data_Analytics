...
select EmployeeName, JobTitle from salaries where not JobTitle like 'Manager';
...
select JobTitle, avg(BasePay) as avgBP from salaries group by JobTitle having avg(BasePay) >= 100000 order by avgBP desc;
